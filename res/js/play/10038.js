...
_.a0={
  ...
  set:function(data){
    ...
    Dom.S.css({'width':1470,'height':25*(D.length+2)+145});
    ...
    html.push('<div class="splitLine2" style="height:'+(26*(D.length+50))+'px;left:250px"></div>');
    html.push('<div class="splitLine2" style="height:'+(26*(D.length+50))+'px;left:500px"></div>');
    html.push('<div class="splitLine2" style="height:'+(26*(D.length+50))+'px;left:750px"></div>');
    html.push('<div class="splitLine2" style="height:'+(26*(D.length+50))+'px;left:1000px"></div>');
...
_.a1={
  ...
  set:function(data){
    var D=data.datalist,i,html=[],h=[],YL=[],YL2=[],tmp=[],t1=[],tI,j,sum,k,w1=[],w2=[],w3=[],w4=[],w5=[];
    Dom.S.css({'width':900,'height':25*(D.length+2)+145});
...
_.a2={
  ...
  set:function(data){
    var D=data.datalist,i,html=[],h=[],YL=[],YL2=[],tmp=[],t1=[],tI,j,sum,k,w1=[],w2=[],w3=[],w4=[],w5=[];
    Dom.S.css({'width':650,'height':25*(D.length+2)+145});
    ...
    html.push('<div class="l1  mt10 title btb"><div class="code3D">'+tmp+'</div><div class="code3D">'+tmp+'</div></div>');
    h.push('<div class="code2 mt10 btb">'+this.fetchSize+'期</div><div class="code2">出现</div><div class="code2">遗漏</div><div class="code2">几率</div>');
