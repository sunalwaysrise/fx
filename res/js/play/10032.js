...
_.a0={
	...
	set:function(data){
		...
		html.push('<div class="l1"><div class="code">最大遗漏</div><div class="red"><em><span>'+data.redmostomission.join('</span></em><em><span>')+'</span></em></div><div class="blue"><em><span>'+data.bluemostomission.join('</span></em><em><span>')+'</span></em></div></div>');		
		html.push('<div class="l1"><div class="code">欲出几率</div><div class="red"><em><span>'+data.redappearrate.join('</span></em><em><span>')+'</span></em></div><div class="blue"><em><span>'+data.blueappearrate.join('</span></em><em><span>')+'</span></em></div></div>');
...
_.a1={
	...
	canvas:_.a0.canvas,
	set:function(data){
		var D=data.datalist,i=0,len,html=[],r1=[],r2=[],r3=[],r4=[],r5=[],r6=[],b1=[],red=[],blue=[];
		i=D.length-1;
		for(i;i>=0;i--){
