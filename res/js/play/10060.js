...
_.a0={
  ...
  set:function(data){
    ...
    tmp=tmp.join('');
    html.push('<div class="l1 title"><div class="code11">'+tmp+'</div><div class="code3 cl5">开奖号码</div><div class="codeKD2 cl6">和值</div></div>');
...
_.a1={
  ...
  set:function(data){
    ...
    html.push('<div class="splitLine" style="height:'+(26*(D.length+12))+'px;left:275px"></div>');
    html.push('<div class="splitLine" style="height:'+(26*(D.length+12))+'px;left:551px"></div>');
...
_.a2={
  ...
  set:function(data){
    ...
    h.push('<div class="issu mt10 btb"></div><div class="code2">'+this.fetchSize+'期</div><div class="code2">出现</div><div class="code2">遗漏</div><div class="code2">欲出</div>');
    ...
    Dom.S.html(html.join('')).css({'width':672,'height':25*(D.length+3)+135});
    Dom.I.html(h.join(''));
    this.setScroll();
    var ctx=document.getElementById("line11_1").getContext('2d');
    ctx.height=25*D.length;
...
_.a3={
  ...
  set:function(data){
    ...
    html.push('<div class="l1 title"><div class="code11">基本号</div><div class="code2"></div></div>');
    i=1;
    for(i;i<12;i++){
      tmp.push('<em><i>'+i.addZero()+'</i></em>');
    }
    ...
    h.push('<div class="issu mt10 btb">'+this.fetchSize+'期</div><div class="issu">遗漏</div><div class="issu">出现</div><div class="issu">欲出</div>');
    html.push('<div class="l1 title mt10 btb"><div class="code11">'+tmp+'</div></div>');
    ...
    Dom.S.html(html.join('')).css({'width':396,'height':25*(D.length+2)+135});
    Dom.I.html(h.join(''));
    this.setScroll();
  },
  buy:function(o,i){
