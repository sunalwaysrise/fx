...
_.a3={
  ...
  set:function(data){
    var D=data.datalist,i,html=[],h=[],YL=[],YL2=[],tmp=[],t1=[],tI,j,sum,k,w1=[],w2=[],w3=[],w4=[],w5=[];
    Dom.S.css({'width':1250,'height':25*(D.length+2)+135});
    html.push('<div class="l1"><div class="code3D">第一位</div><div class="code3D">第二位</div><div class="code3D">第三位</div><div class="code3D">第四位</div><div class="code3"></div><div class="codeKD2"></div></div>');
    i=0;
    for(i;i<10;i++){
      tmp.push('<em><a class="red">'+i+'</a></em>');
    }
    tmp=tmp.join('');
    html.push('<div class="l1"><div class="code3D">'+tmp+'</div><div class="code3D">'+tmp+'</div><div class="code3D">'+tmp+'</div><div class="code3D">'+tmp+'</div><div class="code3">开奖号码</div><div class="codeKD2">和值</div></div>');
    h.push('<div class="issu"></div><div class="issu">期号</div>');
    i=D.length-1;
    for(i;i>=0;i--){
      YL=D[i].miss.split('/');
      ...
      html.push('<div class="code3"><a>'+t1[1]+'</a><a>'+t1[2]+'</a><a>'+t1[3]+'</a><a>'+t1[4]+'</a></div><div class="codeKD2">'+sum+'</div></div>');
    }
    boll=[];i=0;
    for(i;i<10;i++){
      boll.push('<em class="unSelc" onclick="cp2y.main.buy(this);"><i>'+i+'</i></em>');
    ...
    h.push('<div class="issu">选号</div>');
    html.push('<div id="choose" class="l1 setNum"><div id="w1" class="code3D">'+boll.join('')+'</div><div id="w2" class="code3D">'+boll.join('')+'</div><div id="w3" class="code3D">'+boll.join('')+'</div><div id="w4" class="code3D">'+boll.join('')+'</div><div class="code3" onclick="cp2y.main.submit();">去购买</div></div>');
    html.push('<div class="splitLine2" style="height:'+(26*(D.length+6)-6)+'px;left:250px"></div>');
    html.push('<div class="splitLine2" style="height:'+(26*(D.length+6)-6)+'px;left:501px"></div>');
    html.push('<div class="splitLine2" style="height:'+(26*(D.length+6)-6)+'px;left:752px"></div>');
    html.push('<div class="l1  mt10 btb"><div class="code3D">'+tmp+'</div><div class="code3D">'+tmp+'</div><div class="code3D">'+tmp+'</div><div class="code3D">'+tmp+'</div><div class="code2">'+this.fetchSize+'期遗漏</div></div>');
    h.push('<div class="code2 mt10 btb">'+this.fetchSize+'期</div><div class="code2">出现</div><div class="code2">遗漏</div><div class="code2">几率</div>');
    html.push('<div class="l1"><div class="code3D"><em><span>'+data.appearcount2.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.appearcount3.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.appearcount4.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.appearcount5.join('</span></em><em><span>')+'</span></em></div><div class="code2">出现次数</div></div>');    
    html.push('<div class="l1"><div class="code3D"><em><span>'+data.mostomission2.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.mostomission3.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.mostomission4.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.mostomission5.join('</span></em><em><span>')+'</span></em></div><div class="code2">最大遗漏</div></div>');
    html.push('<div class="l1"><div class="code3D"><em><span>'+data.appearrate2.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.appearrate3.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.appearrate4.join('</span></em><em><span>')+'</span></em></div><div class="code3D"><em><span>'+data.appearrate5.join('</span></em><em><span>')+'</span></em></div><div class="code2">欲出几率</div></div>');
    html.push('<canvas id="line3D1" style="left:0" width="250" height="'+25*D.length+'"></canvas>');
    html.push('<canvas id="line3D2" style="left:250px" width="250" height="'+25*D.length+'"></canvas>');
    html.push('<canvas id="line3D3" style="left:500px" width="250" height="'+25*D.length+'"></canvas>');   
    html.push('<canvas id="line3D4" style="left:750px" width="250" height="'+25*D.length+'"></canvas>');   
  ...
  submit:function(){
    ...
    if( ww1.length==0 && ww2.length==0 && ww3.length==0 && ww4.length==0 ){
      return false;
    }else{
